-- ============================================================
-- SNHRC Asset Management System - Seed Data
-- ============================================================
...
-- Update the completed transfer
UPDATE transfers SET status = 'completed', completed_by = 1, completed_at = CURRENT_TIMESTAMP WHERE id = 2;
...
('AST-MED-004', 'transferred', '{"from_branch": "SNHRC North Wing", "to_branch": "SNHRC Main Hospital", "reason": "Required in Cardiology"}', 1),
('AST-IT-003', 'status_changed', '{"old_status": "active", "new_status": "maintenance", "reason": "Firmware upgrade required"}', 1),
('AST-IT-002', 'transferred', '{"from_branch": "SNHRC Main Hospital", "to_branch": "SNHRC South Campus", "reason": "Printer relocated"}', 1);
